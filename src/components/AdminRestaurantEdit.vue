    ...
    <div>
        <b-card bg-variant="light">
            <b-form @submit.prevent="onSubmit()" @reset="onReset">
                <b-form-group
                    label-cols-lg="3"
                    :label="this.initRestaurant.name + ` Restaurant `"
                    label-size="lg"
                ...
                >
                    ...
                    >
                        <b-form-input 
                            ...
                            type="text"
                            name="name"
                            :placeholder="this.initRestaurant.name"
                            required
                        ></b-form-input>
                    </b-form-group>
                    ...
                    >
                        <b-form-input
                            ...
                            :placeholder="this.initRestaurant.tel"
                            type="text"
                            name="tel"
                            required
                        ></b-form-input>
                    ...
                    >
                        <b-form-input
                            ...
                            :placeholder="this.initRestaurant.address"
                            type="text"
                            name="address"
                            required
                        ></b-form-input>
                    ...
                    >
                        <b-form-input
                            ...
                            :placeholder="this.initRestaurant.opening_hours"
                            type="time"
                            name="opening-hours"
                            required
                        ></b-form-input>
                    ...
                    >
                        <b-form-textarea
                            ...
                            :placeholder="this.initRestaurant.description"
                            type="text"
                            rows="3"
                            max-rows="6"
                            name="description"
                    ...
                    >
                        <b-form-file
                            ...
                            :placeholder="this.initRestaurant.image | isNull"
                            accept="image/*"
                            name="image"
                        ></b-form-file>
...
export default {
    ...
    filters: {
        isNull(file) {
            if(!file) return 'Restaurant has no image'
            return 'Restaurant has image'
        }
    },
    data() {
        return {
    ...
    watch: {
        initRestaurant: function(updateData) {
            this.initRestaurant = updateData;
        }
    }
}
</script>